import{E as t}from"./ExtensionSidebar-DB2CzY-9.js";import"./jsx-runtime-u17CrQMm.js";import"./iframe-DQOdDxRp.js";import"./preload-helper-CPNoDHzN.js";const d={title:"Extension/ExtensionSidebar",component:t,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{isLoading:{control:"boolean",description:"Show loading spinner while fetching data from page"}}},e={args:{isLoading:!1,profileData:{firstName:"Grace",lastName:"Ezeaghatise",headline:"Senior Consultant at Rizing HCM · a Wipro company",jobTitle:"Senior Consultant",company:"Rizing HCM",location:"New York, New York, United States",email:"",school:"McGill University",linkedinUrl:"https://linkedin.com/in/grace-ezeaghatise"},onUpdate:a=>console.log("Update contact:",a)}},o={args:{isLoading:!0,profileData:void 0,onUpdate:a=>console.log("Update contact:",a)}},n={args:{isLoading:!1,profileData:{},onUpdate:a=>console.log("Update contact:",a)}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    isLoading: false,
    profileData: {
      firstName: 'Grace',
