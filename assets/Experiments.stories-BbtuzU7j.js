import{S as s}from"./SandboxLayout-CNYlIBbp.js";import"./jsx-runtime-u17CrQMm.js";import"./iframe-kisIfyWl.js";import"./preload-helper-CPNoDHzN.js";import"./LinkedInProfile-TaFtv6Z4.js";import"./ExtensionSidebar-C4mN2ZRo.js";const S={title:"LinkedInSandbox/Experiments",component:s,parameters:{layout:"fullscreen",docs:{description:{component:`LinkedInSandbox — playground for extension experiments.
Each story uses SandboxLayout as the base frame.
Click "Scrape Page" to simulate scraping data from the profile page into the sidebar.`}}}},o={name:"Experiment 0: Default",args:{}},a=[{id:"1",name:"Rizing HCM",positions:[{id:"1-1",title:"Senior Consultant"},{id:"1-2",title:"Consultant"},{id:"1-3",title:"Associate Consultant"}]},{id:"2",name:"McGill University – Desautels Faculty of Management",positions:[{id:"2-1",title:"Project Assistant"}]},{id:"3",name:"U.S.-Ukraine Foundation",positions:[{id:"3-1",title:"Intern"}]},{id:"4",name:"McGill University",positions:[{id:"4-1",title:"Research Assistant"}]}],r={name:"Experiment 1: Company Selector",args:{companies:a,companySelectorMode:"multi"}},e={name:"Experiment 2: Single Company Creation",args:{companies:a,companySelectorMode:"single"}},n={name:"Experiment 3: Visible Default (Company Chip)",args:{companies:a,companySelectorMode:"chip"}},t={name:"Experiment 4: Experience-Anchored Selection",args:{companies:a,companySelectorMode:"anchored"}},i={name:"Experiment 5: Inline Timeline Selector",args:{companies:a,companySelectorMode:"inline"}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
...
3. Watch the COMPANY ASSOCIATIONS section in the sidebar update
   with the selected company`,...t.parameters?.docs?.description}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  name: 'Experiment 5: Inline Timeline Selector',
  args: {
    companies: GRACE_COMPANIES,
    companySelectorMode: 'inline'
  }
}`,...i.parameters?.docs?.source},description:{story:`Experiment 5: Inline Timeline Selector — Collapsible chip always shows the active
...
5. Tick a different position checkbox within the selected company`,...i.parameters?.docs?.description}}};const u=["GraceEzeaghatise","CompanySelectorExperiment","SingleCompanyCreation","VisibleDefaultChip","ExperienceAnchored","InlineFlatList"];export{r as CompanySelectorExperiment,t as ExperienceAnchored,o as GraceEzeaghatise,i as InlineFlatList,e as SingleCompanyCreation,n as VisibleDefaultChip,u as __namedExportsOrder,S as default};
